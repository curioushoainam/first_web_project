...
<form class="well form-horizontal" method="post" enctype="multipart/form-data">
	<fieldset class="creation-border">
		<legend class="creation-border">
			<div class="pull-left">Footer information </div>
			<div class="pull-right"><input type="button" class="btn btn-info" name="footer_edit" value="Edit"></div>		
		</legend>        

	    <div class="form-group">
	        <label class="col-md-2 control-label">Footer</label>
	        <div class="col-md-8">
	           <input id="footer" name="company_name" class="form-control" type="text" readonly>
	        </div>
